...
public class BulkConfiguration extends Fragment implements IMainActivityContract.View {
    private static final String TAG = BulkConfiguration.class.getSimpleName();
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = View.inflate(getContext(), R.layout.navdrawer_bulk_import, null);
