package com.ag.bta.ui.inventories;
...
//        finish();
//
//        startActivity(new Intent(additemFragment.this, LoginActivity.class));
//        Toast.makeText(additemFragment.this,"LOGOUT SUCCESSFUL", Toast.LENGTH_SHORT).show();
