package com.ag.bta.ui.navigationdrawer.adapter;
...
public class NavigationListAdapter extends BaseExpandableListAdapter {
    ...
    public View getChildView(int groupPosition, final int childPosition,
        ...
        if (convertView == null) {
            ...
            convertView = infalInflater.inflate(R.layout.navdrawer_list_item, null);
        }
    ...
    public View getGroupView(final int groupPosition, boolean isExpanded,
        ...
        if (convertView == null) {
            LayoutInflater infalInflater = (LayoutInflater) this.context
                    .getSystemService(Context.LAYOUT_INFLATER_SERVICE);
            convertView = infalInflater.inflate(R.layout.navdrawer_list_group, null);
        }
        ...
        if (isExpanded) {
            ivGroupIndicator.setImageResource(R.drawable.navdrawer_remove);
        } else {
            ivGroupIndicator.setImageResource(R.drawable.navdrawer_add);
        }
