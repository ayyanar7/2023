...
import com.ag.bta.utils.imageutils.imagepicker.SelectDialog;
import com.ag.bta.utils.imageutils.imagepicker.imageloader.GlideImageLoader;
...
public class OpenGalleryActivity extends AppCompatActivity implements ImagePickerAdapter.OnRecyclerViewItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.imagepicker_activity_wxdemo);
        setTitle("Demo");
Log.d("Image picker ", "Inside oncreate WxDemoActivity");
        initImagePicker();
        Log.d("Image picker ", "initImagePicker completed");
        initWidget();
        Log.d("Image picker ", "initWidget completed");
    }
    ...
    private void initImagePicker() {
        ...
        imagePicker.setOutPutX(800);                           //Save the width of the file. Unit pixel
        imagePicker.setOutPutY(800);  //Save the height of the file. Unit pixel
    ...
    private void initWidget() {
        ...
        Log.d("Image picker ", "initwidget ...11111111");
                    ...
                    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                        switch (position) {
                            case 0: //Turn up the camera directly
                                ...
                                Intent intent = new Intent(OpenGalleryActivity.this, ImageGridActivity.class);
                            ...
                            case 1:
                                //Open the selection, the number of choices allowed this time
                                ImagePicker.getInstance().setSelectLimit(maxImgCount - selImageList.size());
                                Intent intent1 = new Intent(OpenGalleryActivity.this, ImageGridActivity.class);
