...
import com.ag.bta.utils.imageutils.imagepicker.imageloader.PicassoImageLoader;
import com.ag.bta.utils.imageutils.imagepicker.wxdemo.OpenGalleryActivity;
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.btn_wxDemo:
                startActivity(new Intent(this, OpenGalleryActivity.class));
                break;
        }
    }
