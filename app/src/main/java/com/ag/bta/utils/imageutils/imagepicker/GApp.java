package com.ag.bta.utils.imageutils.imagepicker;
...
public class GApp extends Application {
    ...
    public static DisplayImageOptions imageLoaderOptions = new DisplayImageOptions.Builder()
            .showImageOnLoading(R.drawable.default_image)    //Set the picture displayed during download
            .showImageForEmptyUri(R.drawable.default_image)  //Set the picture displayed when Uri is empty or wrong
            .showImageOnFail(R.drawable.default_image)       //Set the picture displayed when an error occurs during picture loading/decoding
    ...
    public static ImageOptions xUtilsOptions = new ImageOptions.Builder()
            ...
            .setLoadingDrawableId(R.drawable.default_image)  //Pictures shown in download
            .setFailureDrawableId(R.drawable.default_image)  //Picture displayed when download failed
