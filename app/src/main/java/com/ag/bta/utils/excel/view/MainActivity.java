package com.ag.bta.utils.excel.view;
...
public class MainActivity extends AppCompatActivity implements IMainActivityContract.View {
    ...
    public void initializeViews() {
       ...
       importContactsButton = (Button) findViewById(R.id.import_contact_button)  ;
        exportExcelButton = (Button) findViewById(R.id.export_contact_button)  ;
        readExcelButton = (Button) findViewById(R.id.read_excel_data_button)  ;
        shareButton = (FloatingActionButton) findViewById(R.id.share_excel_floating_button)  ;
        contactsRecyclerView = (RecyclerView) findViewById(R.id.display_contacts_recycler_view) ; //
        constraintLayout =  (ConstraintLayout) findViewById(R.id.constraint_layout);
        lottieAnimationView = (LottieAnimationView) findViewById(R.id.lottie_animation_view);
        importLottieView = (LottieAnimationView) findViewById(R.id.import_contact_lottie);
        exportLottieView = (LottieAnimationView) findViewById(R.id.export_contact_lottie);
        readLottieView = (LottieAnimationView) findViewById(R.id.read_contact_lottie);
